...
<div class="container">
  ...
  <!-- /. PAGE TITLE-->
	...
	<div class="row">
		<div class="span6">
		<div class="media">
				 <a href="#" class="pull-left"><img src="<?= base_url();?>assets/img/icon-service1.png" class="media-object" alt='' /></a>
		...
		<div class="media">
				 <a href="#" class="pull-left"><img src="<?= base_url();?>assets/img/icon-service2.png" class="media-object" alt='' /></a>
				<div class="media-body">
					<h4 class="media-heading">
						Nested media heading
					</h4> 
		...
		<div class="span6">
		<div class="media">
				 <a href="#" class="pull-left"><img src="<?= base_url();?>assets/img/icon-service3.png" class="media-object" alt='' /></a>
				<div class="media-body">
					<h4 class="media-heading">
						Nested media heading
					</h4> 
		...
		<div class="span6">
		<div class="media">
				 <a href="#" class="pull-left"><img src="<?= base_url();?>assets/img/icon-service4.png" class="media-object" alt='' /></a>
				<div class="media-body">
					<h4 class="media-heading">
						Nested media heading
					</h4> 
		...
		<div class="span6">
		<div class="media">
				 <a href="#" class="pull-left"><img src="<?= base_url();?>assets/img/icon-service5.png" class="media-object" alt='' /></a>
				<div class="media-body">
					<h4 class="media-heading">
						Nested media heading
					</h4> 
		...
		<div class="span6">
		<div class="media">
				 <a href="#" class="pull-left"><img src="<?= base_url();?>assets/img/icon-service6.png" class="media-object" alt='' /></a>
				<div class="media-body">
					<h4 class="media-heading">
						Nested media heading
					</h4> 
