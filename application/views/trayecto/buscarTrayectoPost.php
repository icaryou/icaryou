...
<?php if(sizeof($trayectosEncontrados)!=0):?><!--ENCUENTRA TRAYECTOS -->
	<h3>Mostrando trayectos desde <?php echo "{$camposBusqueda['poblacionOrigen']}({$camposBusqueda['cpOrigen']}) a 
	{$camposBusqueda['poblacionDestino']}({$camposBusqueda['cpDestino']})"?>
	</h3>
