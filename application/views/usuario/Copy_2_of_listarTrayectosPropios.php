...
<!-- EN CADA $TRAYECTO AGRUPADO TENEMOS UN SOLO TRAYECTO PERO TANTAS FILAS COMO USUARIOS TENGA ESE TRAYECTO -->
	...
	<?php if($trayectoAgrupado[0]['creador']==$this->session->userdata('id')):?>
		<table class="table borderless">
				...
				<tr><th>Poblacion origen</th><td><?php echo $trayectoAgrupado[0]['poblacionOrigen']?></td></tr>
				<tr><th>Poblacion destino</th><td><?php echo $trayectoAgrupado[0]['poblacionDestino']?></td></tr>
				<tr><th>Hora llegada</th><td><?php echo $trayectoAgrupado[0]['horallegadadestino']?></td></tr>
				<tr><th>Hora regreso</th><td><?php echo $trayectoAgrupado[0]['horaretornodestino']?></td></tr>			
				<tr><th>Dias</th><td><?php echo $trayectoAgrupado[0]['dias']?></td></tr>
				<tr><th>Comentarios</th><td><?php echo $trayectoAgrupado[0]['comentarios']?></td></tr>
				<tr><th>Plazas máximas</th><td><?php echo $trayectoAgrupado[0]['plazas']?></td></tr>
				<tr><th>Usuarios</th><td><?php foreach ($trayectoAgrupado as $usu):?>
