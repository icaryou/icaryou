...
<!-- EN CADA $TRAYECTO AGRUPADO TENEMOS UN SOLO TRAYECTO PERO TANTAS FILAS COMO USUARIOS TENGA ESE TRAYECTO -->
	...
	<?php if($trayectoAgrupado[0]['creador']==$this->session->userdata('id')):?>
		<table class="borderless">
						<tr>
							<td class="bigCity origen"><?php echo $trayectoAgrupado[0]['poblacionOrigen']?></td>
							<td><img src="<?= base_url();?>assets/img/arrow.png" /></td>
							<td class="bigCity destino"><?php echo $trayectoAgrupado[0]['poblacionDestino']?></td>
						</tr>
						<tr>
							<td class="bigCity"><?php echo $trayectoAgrupado[0]['horallegadadestino']?></td>
							<td></td>
							<td class="bigCity"><?php echo $trayectoAgrupado[0]['horaretornodestino']?></td>
						</tr>
						<tr>
							<td colspan="3"><?php echo $trayectoAgrupado[0]['dias']?></td>
						</tr>
						<tr>
							<td colspan="3"><p>
									<strong>Comentarios:</strong>
								</p><?php echo $trayectoAgrupado[0]['comentarios']?></td>
						</tr>
						<tr>
							<td colspan="3"><div class="numberCircle"><?php echo $trayectoAgrupado[0]['plazas']?></div></td>
						</tr>
						<tr>
							<td colspan="3"><?php foreach ($trayectoAgrupado as $usu):?>
								<p>
					...
					<?php endforeach;?></td>
						...
						<tr>
							<td colspan="3"><?php if(!$pintarAbandonar&&$trayectoAgrupado[0]['plazas']>sizeof($trayectoAgrupado)):?>				
